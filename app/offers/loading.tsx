...
export default function OffersLoading() {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      {/* Header Skeleton */}
      <div className="bg-gradient-to-r from-primary to-primary/80 px-4 py-6">
        <div className="h-7 w-36 bg-white/20 rounded skeleton-shimmer" />
        <div className="h-4 w-48 bg-white/20 rounded skeleton-shimmer mt-2" />
      </div>

      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-0 auto-rows-fr pb-20">
        {[...Array(12)].map((_, i) => (
          <div
            key={i}
            className="flex flex-col border-b border-r border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-800 relative h-full"
          >
